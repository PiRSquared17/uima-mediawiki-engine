...
public class Revision extends Annotation {
  ...
  /** getter for comment - gets A comment by the contributor that describes what the correspond new revision is made of in comparison to the previous one.
   * @generated */
  ...
  /** setter for comment - sets A comment by the contributor that describes what the correspond new revision is made of in comparison to the previous one. 
   * @generated */
