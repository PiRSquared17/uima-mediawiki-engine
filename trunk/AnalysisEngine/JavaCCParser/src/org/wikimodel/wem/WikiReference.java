 ...
 * <li>parameters (optional) - additional wiki parameters associated with the reference. It can be a style name, a
 * target of the link or something else.</li>
 * </ul>
 * Instances of this type are immutable so they can be shared between various contexts (like threads, parser instances
 * and so on).
 * 
 * @author kotelnikov
 */
public class WikiReference {
	...
	/**
	 * A human-readable label associated with this reference. This is an optional part of the reference.
	 */
	private final String			fLabel;

	/**
	 * The link corresponding to this reference. It can be a hyperlink, URI or a wiki page name. This is a mandatory
	 * part of the reference.
	 */
	private final String			fLink;

	/**
	 * Additional parameters associated with this reference. This is an optional part of the reference.
	 */
	private final WikiParameters	fParameters;

	/**
	 * This field is used only by {@link #toString()} method to cache the resulting string representation of this
	 * reference.
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof WikiReference))
			return false;
		final WikiReference r = (WikiReference) obj;
		return fLink.equals(r.fLink) && (fLabel == r.fLabel || fLabel != null && fLabel.equals(r.fLabel)) && fParameters.equals(r.fParameters);
	}

	/**
	 * Returns a human-readable label associated with this reference. This is an optional part of the reference so this
	...
	/**
	 * Returns a link of this reference. It can be an a hyperlink, an URI or a wiki name. This part of the reference is
	 * mandatory so the returned value is not empty.
	 * 
	...
	/**
	 * Returns parameters associated with this reference. This method never returns <code>null</code>. If there is no
	 * specific parameters for the reference then this method returns the {@link WikiParameters#EMPTY} instance.
	 * 
	 * @return a non-<code>null</code> object representing parameters of this link
	 */
