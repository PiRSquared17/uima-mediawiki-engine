...
public interface IWemListenerDocument {
	 ...
	 * 
	 * @param headerLevel
	 *            the level of the found header; valid values: 1-6
	 * @param params
	 *            wiki parameters associated with the
	 */
	 ...
	 * 
	 * @param docLevel
	 *            the level (depth) of the document containing this section
	 * @param headerLevel
	 *            the level of the header defining this section
	 * @param params
	 *            parameters parameters of the document or the header
	 */
