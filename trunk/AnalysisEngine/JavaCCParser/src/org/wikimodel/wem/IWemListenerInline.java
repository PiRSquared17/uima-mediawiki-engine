 ...
 * used to represent all types of "natural" elements in the text - words, spaces, new lines and special symbols. Using
 * only these methods it is possible to cover all combinations of all unicode characters. Parsers use these methods to
 * notify about all non-interpreted symbols and their combinations. These methods calls can be considered as the base of
 * any text documents.</dd>
...
public interface IWemListenerInline {
	 ...
	 * 
	 * @param format
	 *            the object defining formatting parameters of in-line elements.
	 */
	 ...
	 * 
	 * @param format
	 *            the formatting object defining how contained in-line elements should be formatted
	 */
	 ...
	 * 
	 * @param str
	 *            the escaped sequence of characters
	 */
	 ...
	 * be found in the middle of a "physical" line so this event is not equals to the {@link #onNewLine()} notification.
	 * 
	 * @see #onNewLine()
	 */
	void onLineBreak();
	 ...
	 * character sequence). Note that the new line symbols are not the same as a forced line break sequence notified by
	 ...
	 * 
	 * @param str
	 *            the sequence of space characters
	 * @see #onWord(String)
	 * @see #onSpecialSymbol(String)
	 * @see #onNewLine()
	 */
	 ...
	 * syntaxes use combinations of these sequences to define structural elements in wiki documents.
	 * 
	 * <pre>
	 ...
	 * 
	 * @param str
	 *            the sequence of special symbols
	 * @see #onSpace(String)
	 * @see #onWord(String)
	 * @see #onNewLine()
	 */
	 ...
	 * 
	 * @param str
	 *            the sequence of non-interpreted characters
	 * @param params
	 *            TODO
	 */
	 ...
	 * are not considered as spaces or special symbols.
	 * 
	 * <pre>
	 ...
	 * 
	 * @param str
	 *            the sequence of characters forming a word
	 * @see #onSpace(String)
	 * @see #onSpecialSymbol(String)
	 * @see #onNewLine()
	 */
