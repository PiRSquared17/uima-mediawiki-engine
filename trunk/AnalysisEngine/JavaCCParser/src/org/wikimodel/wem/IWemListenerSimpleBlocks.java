...
/**
 * This listener re-groups methods used to notify about simple block elements. Each simple block element (like
 * paragraphs) can not have other block elements or documents. Some of them can contain only formatted in-line elements.
 * 
 * @author kotelnikov
 */
public interface IWemListenerSimpleBlocks {
	...
	/**
	 * This method is used to notify about the beginning of a "typed" paragraph. Some wiki syntaxes have special markups
	 * to define simple block elements corresponding to "warnings", "info blocks" and so on. Blocks of this type can
	 * have formatted inline elements.
	 * 
	 * @param infoType
	 *            the "type" of the special block
	 * @param params
	...
	/**
	 * This method is used to notify about a sequence of empty lines. This event can be interpreted as an
	 * "empty paragraph".
	 * 
	 * @param count
	 ...
	 * 
	 * @param str
	 *            the content of the verbatim (pre-formatted) block
	 * @param params
