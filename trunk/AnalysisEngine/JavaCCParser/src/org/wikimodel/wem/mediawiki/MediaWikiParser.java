...
public class MediaWikiParser implements IWikiParser {
	...
	/**
	 * @see org.wikimodel.wem.IWikiParser#parse(java.io.Reader, org.wikimodel.wem.IWemListener)
	 */
	public void parse(Reader reader, IWemListener listener) throws WikiParserException {
		try {
			final MediawikiScanner scanner = new MediawikiScanner(reader);
			final WikiScannerContext context = new WikiScannerContext(listener);
