...
/**
 * This interface is a marker for classes implementing all WEM listeners. In the future it should be removed and
 * replaced by an Object Adapter providing individual listeners. Such a provider should be used something like that:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * Adapter-based approach is much more flexible and it can be used to transparently extend parsers to handle new types
