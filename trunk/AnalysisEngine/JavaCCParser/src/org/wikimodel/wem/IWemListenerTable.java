...
public interface IWemListenerTable {
	 ...
	 * 
	 * @param tableHead
	 *            if this flag is <code>true</code> then the reported cell corresponds to the table head ("th" element);
	 *            otherwise it should be considered as a normal table cell ("td" element).
	 * @param params
