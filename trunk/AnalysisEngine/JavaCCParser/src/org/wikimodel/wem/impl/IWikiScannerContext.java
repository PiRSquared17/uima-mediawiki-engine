...
public interface IWikiScannerContext extends IWemConstants {
	 ...
	 * 
	 * @param headCell
	 *            if this parameter is <code>true</code> then this method starts the header cell at the beginning of the
	 *            line
	 */
	...
	/**
	 * Explicitly starts a new table row. This method should not create a new cell at the beginning of the line. To
	 * automatically create the first row cell the methods {@link #beginTableCell(boolean)} or
	 * {@link #beginTableRow(boolean, WikiParameters, WikiParameters)} should be used.
	 * 
	 * @param rowParameters
	 */
