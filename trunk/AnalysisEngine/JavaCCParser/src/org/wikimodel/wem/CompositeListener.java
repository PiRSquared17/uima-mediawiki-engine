...
/**
 * A composite listener which delegates each listener method call to multiple listeners registered in this composite
 * listener.
 * 
...
public class CompositeListener implements IWemListener {
	...
	/**
	 * An internal list of listeners to which each method call will be delegated.
	 */
	private final IWemListener[]	fListeners;

	/**
	 * @param listeners
	 *            an array of listeners to which all method calls will be delegated
	 */
	...
	public void beginDefinitionDescription() {
		for (final IWemListener listener : fListeners) {
