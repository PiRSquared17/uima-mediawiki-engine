...
/**
 * This interface contains main styles used to define text formatting. Note that individual parsers can extends this set
...
public interface IWemConstants {
	...
	/**
	 * FIXME: there is no such a symbol. Should be replaced by the {@link #TT} element.
	 */
	WikiStyle	MONO	= new WikiStyle("mono");

	/**
	 * References... FIXME: check what does it mean... I (kotelnikov) did not found any references on such an HTML
	 * element. This style should be removed or replaced by something else.
	 */
