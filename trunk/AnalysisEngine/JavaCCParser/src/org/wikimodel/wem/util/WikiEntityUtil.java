...
public class WikiEntityUtil {
	...
	private static void add(String wikiEnity, String htmlEntity, int id) {
		final Entity entity = new Entity(wikiEnity, htmlEntity, id);
	 ...
	 * 
	 * @param htmlEntity
	 *            the HTML entity to transform to the corresponding HTML code
	...
	public static int getHtmlCodeByHtmlEntity(String htmlEntity) {
		final Entity entity = fHtmlToWiki.get(htmlEntity);
	 ...
	 * 
	 * @param wikiEntity
	 *            the wiki entity to transform to the corresponding HTML entity
	...
	public static int getHtmlCodeByWikiSymbol(String wikiEntity) {
		final Entity entity = fWikiToHtml.get(wikiEntity);
		return entity != null ? entity.fHtmlCode : 0;
	}

	/**
	 * @param ch
	 *            for this character the corresponding html entity will be returned
	 * @return an html entity corresponding to the given character
	 */
	public static String getHtmlSymbol(char ch) {
		final Entity entity = fIdToWiki[ch];
		return entity != null ? entity.fWikiSymbol : null;
	}

	/**
	 * @param wikiEntity
	 *            for this wiki entity the corresponding html entity will be returned
	...
	/**
	 * @param ch
	 *            for this character the corresponding wiki entity will be returned
	...
	/**
	 * @param htmlEntity
	 *            for this html entity the corresponding wiki entity will be returned
