...
public class TocBuilder {
	...
	public boolean checkDepth() {
		final int documentDepth = fBaseLevelStack.size();
		final int headerLevel = getHeaderLevel();
		return documentDepth <= fMaxSectionDepth && headerLevel <= fMaxHeaderDepth && documentDepth + headerLevel <= fTotalDepth;
	}
	...
	public void endDocument() {
		setHeaderLevel(0);
		final Integer level = fBaseLevelStack.pop();
