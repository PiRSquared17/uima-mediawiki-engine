...
public class HtmlEntityUtil {
	 ...
	 */
	private static Map<Integer, CharInfo>	fCodeMap	= new HashMap<Integer, CharInfo>();

	/**
	 * This map contains descriptions of entities
	 */
	private static Map<String, CharInfo>	fSymbolMap	= new HashMap<String, CharInfo>();
	...
	static {
		...
		/*
		 * Portions International Organization for Standardization 1986: Permission to copy in any form is granted for
		 * use with conforming SGML systems and applications as defined in ISO 8879, provided this notice is included in
		 * all copies.
		 */

		/*
		 * Relevant ISO entity set is given unless names are newly introduced. New names (ie, not in ISO 8879 list) do
		 * not clash with any existing ISO 8879 entity names. Unicode character numbers are given for each character, in
		 * hex, and are identical for Unicode 1.1 and Unicode 2.0. CDATA values are decimal conversions of the Unicode
		 * values. Names are Unicode 2.0 names.
		 */
		 ...
		 * not clash with any existing ISO 8879 entity names. Unicode character numbers are given for each character, in
		 * hex, and are identical for Unicode 1.1 and Unicode 2.0. CDATA values are decimal conversions of the Unicode
		 * values. Names are Unicode 2.0 names. C0 Controls and Basic Latin
		 */
	...
	private static void add(String symbol, int code, String descr) {
		final CharInfo info = new CharInfo(symbol, code, descr);
	 ...
	 * 
	 * @param symbol
	 *            for this symbol the corresponding character will be returned
	 * @return a character corresponding to the given symbol
	 */
	public static char getChar(String symbol) {
		final CharInfo info = (CharInfo) fSymbolMap.get(symbol);
	 ...
	 * 
	 * @param ch
	 *            for this character the corresponding description will be returned
	 * @return description of the given character
	 */
	public static String getDescription(char ch) {
		final CharInfo info = (CharInfo) fCodeMap.get(new Integer(ch));
	 ...
	 * 
	 * @param symbol
	 *            for this symbol the corresponding description will be returned
	...
	/**
	 * Returns a symbol corresponding to the given character or <code>null</code> if nothing was found
	 * 
	 * @param ch
	 *            for this character the corresponding symbol will be returned
